...
<div class="box-1">
 ...
 <form action="Add doctor Information.php" method="post">
 		<div class="box-2">
 ...
 <br><br>
 <div class="box-3">
 <input type="submit" name="submit" class="submit-box"value= "Submit"><br><br><br>
...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO doctorlist (id, name, department, contact)
	values ('$id', '$name', '$department', '$contact')";
